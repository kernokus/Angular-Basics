...
export class FormComponent implements OnInit  {
	...
	ngOnInit():void {
		...
		this.service.lenghtNums=this.service.nums.size

		//обработка информации с input
	...
	//запоминание состояния multiselect + разделение на 2 вида запросов + обновление данных
    ...
    clickRadioBtn(id:number):void {
	//запоминание состояния radioButtons + обновление данных
